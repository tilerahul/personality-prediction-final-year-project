...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center stikcy-top">
            ...
            <form action="UserLoginController" method="post">
              <div class="row gy-4">
                ...
                <div class="col-md-12 text-center">
                  ...
                  <button type="submit" style="background-color:#388da8; color:white;" class="btn">Login</button> &nbsp;&nbsp;<a href="UserRegistration.jsp">New User?</a>
                </div>
