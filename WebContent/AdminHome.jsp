    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Welcome to <span>Personality Prediction System</span></h1>
          <p data-aos="fade-up" data-aos-delay="100">Personality Traits Prediction Using Facial Images<br></p>
